...
def predict():
    if request.method == 'POST':
        ...
        result = 'Safe to Use URL ✅' if prediction[0] == 0 else 'Malicious URL Detected ❌'

        # Render the result on the webpage with styling
        result_class = "safe" if prediction[0] == 0 else "malicious"
